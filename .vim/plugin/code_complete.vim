...
let g:template['c']['ife0'] = "if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} else {\<cr>".g:rs."...".
            \g:re."\<cr>}"
let g:template['c']['ife1'] = "if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else {\<cr>".g:rs."...".
            \g:re."\<cr>}"
let g:template['c']['ife2'] = "if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else {\<cr>".g:rs."...".
            \g:re."\<cr>}"
let g:template['c']['ife3'] = "if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else if (".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>} ".
            \"else\<cr>{\<cr>".g:rs."...".
...
let g:template['c']['f0']=g:rs."...".g:re."() {\<cr>".g:rs."...".g:re."\<cr>}"
let g:template['c']['f1']=g:rs."...".g:re."(".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>}"
let g:template['c']['f2']=g:rs."...".g:re."(".g:rs."...".g:re.", ".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>}"
let g:template['c']['f3']=g:rs."...".g:re."(".g:rs."...".g:re.", ".g:rs."...".g:re.", ".g:rs."...".g:re.") {\<cr>".g:rs."...".g:re."\<cr>}"
